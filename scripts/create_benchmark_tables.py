...
datasets = [
    {
        ...
        "table": "hits",
        "source_prefix": "benchmarks/clickbench/hits/"
    },
    {
        "namespace": "tpc_h",
        "table": "customer",
        "source_prefix": "benchmarks/tpc_h/customer/"
    },
    {
        "namespace": "tpc_h",
        "table": "lineitem",
        "source_prefix": "benchmarks/tpc_h/lineitem/"
    },
    {
        "namespace": "tpc_h",
        "table": "nation",
        "source_prefix": "benchmarks/tpc_h/nation/"
    },
    {
        "namespace": "tpc_h",
        "table": "orders",
        "source_prefix": "benchmarks/tpc_h/orders/"
    },
    {
        "namespace": "tpc_h",
        "table": "part",
        "source_prefix": "benchmarks/tpc_h/part/"
    },
    {
        "namespace": "tpc_h",
        "table": "partsupp",
        "source_prefix": "benchmarks/tpc_h/partsupp/"
    },
    {
        "namespace": "tpc_h",
        "table": "region",
        "source_prefix": "benchmarks/tpc_h/region/"
    },
    {
        "namespace": "tpc_h",
        "table": "supplier",
        "source_prefix": "benchmarks/tpc_h/supplier/"
    },
]
