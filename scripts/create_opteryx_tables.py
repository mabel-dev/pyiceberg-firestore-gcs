...
datasets = [
    ...
    },
    {
        "namespace": "ops",
        "table": "request_log",
        "source_prefix": "opteryx/ops/request_log/data/"
    },
    {
        "namespace": "ops",
        "table": "stderr_log",
        "source_prefix": "opteryx/ops/stderr_log/data/"
    },
    {
        "namespace": "ops",
        "table": "stdout_log",
        "source_prefix": "opteryx/ops/stdout_log/data/"
    },
    {
        "namespace": "ops",
        "table": "varlog",
        "source_prefix": "opteryx/ops/varlog/data/"
    },
]
...
for dataset in datasets:
    ...
    try:
        ...
        print(f"   Schema: {schema.names[:5]}{'...' if len(schema.names) > 5 else ''} ({len(schema.names)} columns)")
    ...
    if catalog.table_exists(identifier):
        print(f"   ⚠️  Table already exists, dropping and recreating...")
        try:
